\chapter{Construção da Ferramenta \textit{tjscraper}~\label{chp:construção-da-ferramenta}}
...
existentes em cada um dos tipos (\Cref{tbl:dificuldades-tipos-de-busca}), foi
